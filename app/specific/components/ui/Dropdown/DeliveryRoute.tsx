...
const DeliveryRoute: FunctionComponent<{
    ...
    const response = api.specific.deliveryRoute.getInfinite.useInfiniteQuery(
        {
    ...
    return (
        <SearchWithResults
            ...
            placeholder={translate(dictionary, 'clients:choose_delivery_route')}
