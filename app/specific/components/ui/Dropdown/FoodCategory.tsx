...
const FoodCategoryDropdown: FunctionComponent<{
    ...
    //     }
    // );
    const response = api.specific.foodCategory.getInfinite.useInfiniteQuery(
        {
    ...
    return <SearchWithResults
        ...
        placeholder={translate(dictionary, 'food:food_category_placeholder')}
