...
const MealCategoryDropdown: FunctionComponent<{
    ...
    //     }
    // );
    const response = api.specific.mealCategory.getInfinite.useInfiniteQuery(
        {
    ...
    return <SearchWithResults
        ...
        placeholder={translate(dictionary, 'meals:meal_category_placeholder')}
...
export default MealCategoryDropdown;