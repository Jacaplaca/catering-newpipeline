...
import useColumns from '@root/app/specific/components/Clients/Category/useColumns';
import useDataGrid from '@root/app/specific/components/Clients/Category/useDataGrid';
import useFetch from '@root/app/specific/components/Clients/Category/useFetch';
import useRow from '@root/app/specific/components/Clients/Category/useRow';
import useAction from '@root/app/specific/components/Clients/Category/useRowAction';
import { type SettingParsedType } from '@root/types';
import { type ClientCategorySortName } from '@root/types/specific';
import { useEffect } from 'react';

const useClientCategoryTable = ({
    lang,
    pageName,
    settings,
    dictionary,
    ...
    const { sort, sortDirection, sortName } = useTableSort<ClientCategorySortName>("name")
    ...
    const [rows, setRows] = useRows<ClientCategory>(fetchedRows);
...
export default useClientCategoryTable;