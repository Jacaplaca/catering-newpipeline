import { Meal, MealCategory, type Allergen } from '@prisma/client';
...
import useColumns from '@root/app/specific/components/Meals/Main/useColumns';
import useDataGrid from '@root/app/specific/components/Meals/Main/useDataGrid';
import useFetch from '@root/app/specific/components/Meals/Main/useFetch';
import useRow from '@root/app/specific/components/Meals/Main/useRow';
import useAction from '@root/app/specific/components/Meals/Main/useRowAction';
import { type SettingParsedType } from '@root/types';
import { MealCustomTable, type MealSortName } from '@root/types/specific';
...
const useMealTable = ({
    ...
    const { sort, sortDirection, sortName } = useTableSort<MealSortName>("name")
    ...
    const [rows, setRows] = useRows<MealCustomTable>(fetchedRows);
