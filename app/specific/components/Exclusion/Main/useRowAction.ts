...
import useRemoveExclusion from '@root/app/specific/components/Exclusion/Main/actions/useRemove';
import { type TableActionType } from '@root/types';
import { useState } from 'react';

const useExclusionAction = ({
    rows,
    onSuccess,
}: {
    rows: string[],
    ...
    const remove = useRemoveExclusion({ onSuccess, ids: idsChecked })
...
export default useExclusionAction;