...
import AllergenExpandedRow from '@root/app/specific/components/Allergens/ExpandedRow';
import { api } from '@root/app/trpc/react';
import TableToast from '@root/app/_components/Table/Toast';

const AllergensTable: FunctionComponent = () => {
    const {
        pageName,
        lang,
        dictionary,
    ...
    return (
        <div className='relative'>
            ...
            <MainModal
                isOpen={isAddOpen}
                closeModal={addClose}
                header={t(dictionary, 'allergens:add_allergen')}
            >
                <AllergenExpandedRow />
            </MainModal>
            <TableWrapper>
                <TableHeader
                    ...
                    searchPlaceholder={'allergens:search_placeholder'}
                >
                    <MyButton
                        onClick={addOpen}
                        icon='fa-solid fa-wheat-slash'
                        id={t(dictionary, 'allergens:add_allergen')}
                        ariaLabel={t(dictionary, 'allergens:add_allergen')}
                    >{t(dictionary, 'allergens:add_allergen')}</MyButton>
                </TableHeader>
                <QuickFilterRow
                    dictionary={dictionary}
                    columns={columns}
                ...
                >
                    ...
                    <TableContent
                        ...
                        ExpandedRow={AllergenExpandedRow}
                    />
                </Table>
                <TableFooter
