...
import useFoodCategoryInputs from '@root/app/specific/components/Food/Category/ExpandedRow/useInputs';
...
const FoodCategoryInputs = () => {
    ...
    const inputs = useFoodCategoryInputs();

    const Inputs = getInputsBulk<keyof z.infer<typeof foodCategoryEditValidator>>({
        inputs,
        dictionary,
...
export default FoodCategoryInputs;